...
{
    import com.demo.core.data.*;
    import flash.geom.*;
    
    public final class N_HitData extends Object
    {
        public function N_HitData(arg1:com.demo.frameworks.combat.hit.N_AtkHit, arg2:int, arg3:int, arg4:flash.geom.Rectangle)
        {
            super();
            this._owner = arg1;
            this._key = arg2;
        ...
        public function get owner():com.demo.frameworks.combat.hit.N_AtkHit
        {
            return this._owner;
        }
        ...
        public function checkHit(arg1:com.demo.core.data.BlockData):Boolean
        {
        ...
        private var _owner:com.demo.frameworks.combat.hit.N_AtkHit;
