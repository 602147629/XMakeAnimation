package com.demo.frameworks.combat.hit
{
    import com.demo.define.*;
    ...
    public final class N_AtkHit extends Object
    {
        ...
        public function getBy(arg1:int):com.demo.frameworks.combat.hit.N_HitData
        {
        ...
        public function drawHitData(arg1:com.demo.frameworks.combat.hit.N_HitData):void
        {
            var loc1:*=null;
        ...
        public function parseObj(arg1:Object):void
        {
            ...
            this._mode = com.demo.frameworks.combat.hit.N_HitMode.getType(arg1.modeName);
            this._type = com.demo.frameworks.combat.hit.N_HitType.getType(arg1.typeName);
            ...
            while (loc8 < loc2) 
            {
                loc4 = arg1.sames[com.demo.util.MathUtil.clamp(loc8, 0, loc3)];
                loc7 = arg1.sources[com.demo.util.MathUtil.clamp(loc8, 0, loc5)];
                loc6 = new flash.geom.Rectangle(loc7.x, loc7.y, loc7.width, loc7.height);
                loc1 = new com.demo.frameworks.combat.hit.N_HitData(this, arg1.keys[loc8], loc4, loc6);
