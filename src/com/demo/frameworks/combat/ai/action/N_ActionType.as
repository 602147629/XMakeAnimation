package com.demo.frameworks.combat.ai.action {
	...
	public final class N_ActionType {
		private static var _list : Array = ["呼吸", "战斗呼吸", "行走", "跑动", "跑攻", "飞行", "跳跃", "跳攻", "后退", "浮空", "掉落", "反弹", "站起", "被吸", "死亡", "攻击", "连击_0", "连击_1", "连击_2", "射击", "滚击", "砸地", "自爆", "冲撞"];
		...
		public static const SELF_EXPLODE : int = 22;
		public static const DASH : int = 23;
